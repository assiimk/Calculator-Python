...
def cal():
    ...
    entry = Entry(root, justify="center", font=entry_font)
    ...
    button15 = Button(root, text='حذف', bg=other_button_bg, padx=10, pady=3,
    ...
    exit = Button(root, text='خروج', fg='white', bg='red', command=quit, height=1, width=7)
